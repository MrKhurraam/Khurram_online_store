    ...
    Category(
      ...
      subCategories: [
        SubCategory(
          ...
          icon: IconFontHelper.MEATS,
          parts: [
            CategoryPart(name: 'Ham', imgName: 'cat1_1_p1', isSelected: false),
            CategoryPart(name: 'Paws', imgName: 'cat1_1_p2', isSelected: false),
            CategoryPart(
                name: 'Bacon', imgName: 'cat1_1_p3', isSelected: false),
            CategoryPart(name: 'Loin', imgName: 'cat1_1_p4', isSelected: false),
            CategoryPart(name: 'Ribs', imgName: 'cat1_1_p5', isSelected: false),
            CategoryPart(
        ...
        SubCategory(
          ...
          parts: [
            ...
            CategoryPart(name: 'Leg', imgName: 'cat1_2_p3', isSelected: false),
            CategoryPart(
                name: 'Panjaa', imgName: 'cat1_2_p4', isSelected: false),
            CategoryPart(
                name: 'Pota Kaleeji', imgName: 'cat1_2_p5', isSelected: false),
          ],
        ),
        SubCategory(
          color: AppColors.MEATS,
        ...
        SubCategory(
          ...
          parts: [
            ...
            CategoryPart(name: 'Leg', imgName: 'cat1_4_p2', isSelected: false),
            CategoryPart(name: 'Mix', imgName: 'cat1_4_p3', isSelected: false),
          ],
        ),
        SubCategory(
          color: AppColors.MEATS,
          ...
          parts: [
            ...
            CategoryPart(name: 'Mix', imgName: 'cat1_5_p2', isSelected: false),
            CategoryPart(
        ...
        SubCategory(
          ...
          icon: IconFontHelper.MEATS,
          parts: [
            CategoryPart(name: 'Mix', imgName: 'cat1_6_p1', isSelected: false),
            CategoryPart(name: 'Leg', imgName: 'cat1_6_p2', isSelected: false),
          ],
        ),
      ],
    ),
